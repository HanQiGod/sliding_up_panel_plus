## [Unreleased]
### Documentation
- Renamed package references from `sliding_up_panel` to `sliding_up_panel_plus`
...
This is the initial release of the sliding_up_panel_plus package. This includes features such as
