...
Widget build(BuildContext context) {
  return Scaffold(
    appBar: AppBar(
      title: Text("SlidingUpPanelPlusExample"),
    ),
    body: SlidingUpPanel(
      panel: Center(
...
<p float="left">
  <img alt="Panel Closed" width="217px" src="screenshots/simpleusageclosed.png">
  <img alt="Panel Midway" width="217px" src="screenshots/simpleusagemidway.png">
  <img alt="Panel Open" width="217px" src="screenshots/simpleusageopen.png">
</p>
...
|`panelBuilder` [beta]| NOTE: This feature is still in beta and may have some problems. Please open an issue on GitHub if you encounter something unexpected. <br><br> Provides a `ScrollController` to attach to a scrollable object in the panel that links the panel position with the scroll position. Useful for implementing an infinite scroll behavior. If `panel` and `panelBuilder` are both non-null, `panel` will be used. |
...
<p float="left">
  <img alt="Panel Closed" width="217px" src="screenshots/backdropclosed.png">
  <img alt="Panel Midway" width="217px" src="screenshots/backdropmidway.png">
  <img alt="Panel Open" width="217px" src="screenshots/backdropopen.png">
</p>
...
<p float="left">
  <img alt="Panel Closed" width="217px" src="screenshots/collapsedpanelclosed.png">
  <img alt="Panel Midway" width="217px" src="screenshots/collapsedpanelmidway.png">
  <img alt="Panel Open" width="217px" src="screenshots/collapsedpanelopen.png">
</p>
...
<p float="left">
  <img alt="Panel Closed" width="217px" src="screenshots/borderclosed.png">
  <img alt="Panel Midway" width="217px" src="screenshots/bordermidway.png">
  <img alt="Panel Open" width="217px" src="screenshots/borderopen.png">
</p>
...
<p float="left">
  <img alt="Panel Closed" width="217px" src="screenshots/floatingclosed.png">
  <img alt="Panel Midway" width="217px" src="screenshots/floatingmidway.png">
  <img alt="Panel Open" width="217px" src="screenshots/floatingopen.png">
</p>
...
<p float="left">
  <img alt="Panel Closed" width="217px" src="screenshots/scrollclosed.png">
  <img alt="Panel Midway" width="217px" src="screenshots/scrollmidway.png">
  <img alt="Panel Open" width="217px" src="screenshots/scrollopen.png">
</p>
...
|`animatePanelToSnapPoint(double value, {Duration duration, Curve curve = Curves.linear})` [beta]| `Future<void>` | NOTE: This feature is still in beta and may have some problems. Please open an issue on GitHub if you encounter something unexpected. <br><br> Animates the panel position to the snap point. Requires that the SlidingUpPanel `snapPoint` property is not null. (optional) `duration` specifies the time for the animation to complete. (optional) `curve` specifies the easing behavior of the animation. |
